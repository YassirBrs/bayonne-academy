...
const builtInTranslations = {
  ...
  "Start With Us": "Start with us",
      ...
      "Niveau actuel": "Current level",
      "Niveau de l’enfant": "Child's level",
      "Choisir un niveau": "Choose a level",
      "Débutant complet": "Complete beginner",
      "Je connais les lettres": "I know the letters",
      "Je lis lentement": "I read slowly",
      "Intermédiaire": "Intermediate",
      "Avancé": "Advanced",
      "Je ne sais pas encore": "I do not know yet",
      "Reconnaît quelques lettres": "Recognizes a few letters",
      "Lit des syllabes": "Reads syllables",
      "Lit des mots simples": "Reads simple words",
      "Lit déjà des phrases": "Already reads sentences",
...
const detailPageTranslations = {
  ...
  "Recommandé parents": "Recommended for parents",
  "Le plus direct": "Most direct",
  "paiement complet": "full payment",
  "/mois": "/month",
  "session": "session",
  "Points forts du plan": "Plan highlights",
  "Un cadre structuré pour lecture, compréhension, expression orale et suivi de progression.": "A structured framework for reading, comprehension, oral expression and progress tracking.",
  "Évaluation du niveau avant démarrage": "Level assessment before starting",
  "Lecture, compréhension et communication": "Reading, comprehension and communication",
  "Plan de progression clair": "Clear progress plan",
  "Choix individualisé ou groupe": "Individualized or group choice",
  "Paiement mensuel séparé": "Separate monthly payment",
  "Confirmation finale sur WhatsApp": "Final confirmation on WhatsApp",
  "Une option plus souple pour avancer avec le même cadre sur plusieurs mois.": "A more flexible option to progress with the same framework over several months.",
  "Jusqu’à 10 mensualités": "Up to 10 monthly payments",
  "Même programme que le complet": "Same programme as the full plan",
  "Rythme adapté à vos disponibilités": "Pace adapted to your availability",
  "Séances de 1h à 2h": "1h to 2h sessions",
  "Remise paiement complet": "Full-payment discount",
  "Détails confirmés avec l’équipe": "Details confirmed with the team",
  "Pour renforcer les phrases utiles, le vocabulaire actif et l’aisance orale.": "To strengthen useful sentences, active vocabulary and oral ease.",
  "Expression orale guidée": "Guided oral expression",
  "Situations de la vie quotidienne": "Everyday-life situations",
  "Correction de prononciation": "Pronunciation correction",
  "Format individuel ou groupe": "Individual or group format",
  "Parcours lecture complet inclus": "Full reading path included",
  "Orientation selon votre objectif": "Guidance according to your goal",
  "Diagnostic rapide": "Quick diagnosis",
  "Conseil de rythme": "Pace recommendation",
  "Recommandation de parcours": "Programme recommendation",
  "Suivi long inclus": "Long-term follow-up included",
  "Place garantie en groupe": "Guaranteed group place",
  "Idéal avant inscription": "Ideal before registration",
  "Lecture, vocabulaire, compréhension et expression orale avec un rythme adapté à l’âge.": "Reading, vocabulary, comprehension and oral expression with an age-appropriate pace.",
  "Évaluation de l’âge et du niveau": "Age and level assessment",
  "Lecture guidée et vocabulaire vivant": "Guided reading and living vocabulary",
  "Retour parent après progression": "Parent feedback after progress",
  "Durée de 1h à 2h": "Duration from 1h to 2h",
  "Rythme intensif obligatoire": "Mandatory intensive pace",
  "Créneau confirmé sur WhatsApp": "Slot confirmed on WhatsApp",
  "Attention centrée sur l’enfant": "Attention focused on the child",
  "Correction plus rapide": "Faster correction",
  "Objectifs familiaux intégrés": "Family goals included",
  "Planning plus flexible": "More flexible schedule",
  "Dynamique de groupe": "Group dynamic",
  "Pour besoins spécifiques": "For specific needs",
  "Cadre collectif motivant": "Motivating group framework",
  "Niveaux proches regroupés": "Similar levels grouped together",
  "Expression orale en interaction": "Interactive oral expression",
  "Rythme régulier": "Regular pace",
  "Créneau totalement personnalisé": "Fully personalized slot",
  "Sous réserve de place": "Subject to availability",
  "Diagnostic enfant": "Child diagnosis",
  "Conseil pour les parents": "Advice for parents",
  "Choix individuel ou groupe": "Individual or group choice",
  "Programme complet inclus": "Full programme included",
  "Suivi hebdomadaire inclus": "Weekly follow-up included",
  "Idéal pour commencer": "Ideal to start",
  "Phrases utiles et vocabulaire actif": "Useful sentences and active vocabulary",
  "Mises en situation guidées": "Guided role-play situations",
  "Programme lecture complet": "Full reading programme",
  "Rythme validé sur WhatsApp": "Pace validated on WhatsApp",
  "Lecture et compréhension incluses": "Reading and comprehension included",
  "Expression orale travaillée": "Oral expression practiced",
  "Plan de progression complet": "Complete progress plan",
